...
import IntroVideo from "./assets/videos/how to convert doc to odt.mp4";
import IntroPoster from "./assets/images/doc to odt poster.png";
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const convertedFile = new File(
        [save],
        file.name.replace(/\.(doc|docx)$/i, "") + ".odt",
        {
          type: "application/vnd.oasis.opendocument.text",
        }
      );
