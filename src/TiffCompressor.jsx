...
import IntroVideo from "./assets/videos/how to compress tiff.mp4";
import IntroPoster from "./assets/images/tiff compress poster.png";
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://fileunivers.com/tiffcompressor" />
      ...
      <section>
        <div className="compressor-page">
          ...
          <ul className="compressor-benefits">
            <li>     Retains image clarity and resolution</li>
