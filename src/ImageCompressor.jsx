...
const ImageCompressor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      [response.data],
      file.name.replace(/\.(jpg|jpeg|png|webp)$/i, "") + "_compressed.webp",
      {
        type: response.data.type || "image/webp",
      }
    );

    setConvertedFile(compressedImage);
  ...
  Also check other features Related to PDF and Image file
</h2>
  ...
  <Link to="/merge-pdf" className="fu-tool-link">
    Merge PDF
          ...
          <div className="compressor-article">
            ...
            <h3>     What Are Image Compression Tools?</h3>
            <p>
